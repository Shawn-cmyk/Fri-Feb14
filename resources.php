...
<body>
    <div class="formback">
        ...
        <div class="container">
            ...
            <h4 class="FormET text-white w-25 p-3 mt-5 float-left ">New Resources</h4>



            <div class="container  float-left col-md-6 ml-3 mt-5 mb-4">
            ...
            <div class="row ">
                <div class="col-md-4">
                    <a href="dashboard.php" class="btn-flat-simple mr-4 mt-5" style="width:200px;">
